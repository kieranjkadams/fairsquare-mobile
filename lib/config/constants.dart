abstract class AppConstants {
  ...
  static const expenseCategories = [
    'property-tax', 'insurance', 'strata', 'utilities',
    'maintenance', 'closing-costs', 'renovation', 'legal', 'other',
  ];
  static const mortgageCategories = [
    'mortgage', 'mortgage-principal', 'mortgage-interest',
    'mortgage-insurance', 'mortgage-prepayment',
  ];

  static List<String> get userCategories => [
    ...capitalCategories, ...incomeCategories, ...expenseCategories,
  ];

  static String categoryLabel(String category) {
    switch (category) {
      case 'down-payment': return 'Down Payment';
      ...
      case 'closing-costs': return 'Closing Costs';
      case 'renovation': return 'Renovation';
      case 'legal': return 'Legal';
      case 'other': return 'Other';
      case 'mortgage': return 'Mortgage';
      case 'mortgage-principal': return 'Mortgage Principal';
      case 'mortgage-interest': return 'Mortgage Interest';
      case 'mortgage-insurance': return 'Mortgage Insurance';
      case 'mortgage-prepayment': return 'Mortgage Prepayment';
